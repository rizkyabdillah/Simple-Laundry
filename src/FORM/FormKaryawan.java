...
import DIALOG.DialogAddKaryawan;
...
public class FormKaryawan extends javax.swing.JDialog{
    ...
    private final String header[] = {
        "Id Karyawan", "Nama Karyawan", "Jenis Kelamin", "No Telpon", "Alamat", "Username", "Password"
    };
    ...
    private void showTabel(String key) {
        try {
            String sql = "SELECT * FROM VIEW_KARYAWAN WHERE "
                    + "id_user LIKE '%" + key + "%' OR "
            ...
            tabel.getColumnModel().getColumn(4).setMinWidth(300);
            tabel.getColumnModel().getColumn(5).setMinWidth(130);
            tabel.getColumnModel().getColumn(6).setMinWidth(130);
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("FORM KELOLA KARYAWAN");
    ...
    private void onTambah(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_onTambah
        ...
        new DialogAddKaryawan(null, true).setVisible(true);
        showTabel("");
        id = "";
    ...
    private void onHapus(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_onHapus
        if(!id.equals("")) {
            int i = dialog.showConfirm("Apakah anda yakin ingin menghapus karyawan bernama " + nama + " ?");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            FormKaryawan dialog = new FormKaryawan(new javax.swing.JFrame(), true);
